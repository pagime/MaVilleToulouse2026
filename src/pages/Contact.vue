...
<template>
  <div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 mb-6">
      <h2 class="text-lg font-semibold text-neutral-800 mb-4">Pour les candidats et leurs équipes</h2>
      <p class="text-sm text-neutral-700 mb-4">
        Vous pouvez nous contacter pour :
      </p>
      <ul class="text-sm text-neutral-600 list-disc list-inside space-y-2 mb-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
      <h2 class="text-lg font-semibold text-neutral-800 mb-4">Pour les citoyens</h2>
      <p class="text-sm text-neutral-700 mb-4">
