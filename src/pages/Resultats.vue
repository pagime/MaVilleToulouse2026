  ...
  <div v-if="results.length">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-8">
      <div
        ...
        class="bg-white rounded-xl shadow-sm border border-neutral-200 p-5"
      >
        ...
        <p class="text-sm text-neutral-500">{{ result.candidat.parti }}</p>
        <router-link
    ...
    <div class="mb-8">
      <h2 class="text-xl font-bold text-neutral-800 mb-4">Détail question par question</h2>
      <div class="space-y-3">
        <div
        ...
        >
          ...
          <div v-if="openDetails[question.id]" class="px-5 pb-5 border-t border-neutral-100">
            <div class="pt-4 space-y-3">
              ...
              >
                <span class="font-medium text-neutral-700 shrink-0">
                  {{ result.candidat.prenom }} {{ result.candidat.nom }} :
                </span>
